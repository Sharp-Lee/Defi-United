import {
  ...
  type BrowserChainRecordInput,
  type BrowserRpcEndpoint,
} from "../../core/chains";
...
export function PwaChainSettingsPanel({
  ...
  return (
    <section className="pwa-settings-panel" aria-labelledby="pwa-chain-settings-title">
      <header className="section-header">
        <div>
          <h2 id="pwa-chain-settings-title">链与 Fee 设置</h2>
